...
public class GameObject {
    ...
    public boolean overlaps(GameObject other) {
        Location l1 = new Location(this.getLeftX(), this.getTopY());
        Location r1 = new Location(this.getRightX(), this.getBottomY());
        Location l2 = new Location(other.getLeftX(), other.getTopY());
        Location r2 = new Location(other.getRightX(), other.getBottomY());
    ...
    public boolean isInside(int x, int y) {
        return this.getLeftX() <= x && this.getRightX() >= x && this.getTopY() <= y && this.getBottomY() >= y;
    }
